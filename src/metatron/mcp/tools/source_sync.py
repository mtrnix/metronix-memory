"""MCP tool: metatron_source_sync — trigger a background sync for a source."""
...
@mcp.tool(
    description=(
        ...
        "connector_type}. Poll metatron_source_list to observe completion "
...
async def metatron_source_sync(
    connection_id: str,
    ...
    try:
        ...
        from metatron.mcp.tools.models import SourceSyncResponse
        ...
        return {"error": handle_tool_error("metatron_source_sync", e).to_dict()}
