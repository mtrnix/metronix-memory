"""MCP tool: metatron_source_delete — delete a data-source connection."""
...
async def metatron_source_delete(
    connection_id: str,
    ...
    try:
        ...
        return {"error": handle_tool_error("metatron_source_delete", e).to_dict()}
