"""MCP tool: metatron_search_fast — low-latency dense+metadata retrieval."""
...
from metatron.mcp.tools.models import SearchFastItem, SearchFastResponse
...
async def metatron_search_fast(
    query: str,
    ...
    try:
        ...
        error = handle_tool_error("metatron_search_fast", exc)
