...
Moved from ``metatron.memory.freshness.decision_engine`` in Phase B
(MTRNIX-313). ``apply_decision`` was extracted to
:mod:`metatron.freshness.apply_decision` so it can take a
...
The protocol lives in this module (not in :mod:`metatron.core.interfaces`) —
