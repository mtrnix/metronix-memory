...
class AgentRouter:
    ...
    def _parse_upload(self, content: bytes, filename: str, ext: str) -> str:
        ...
        if ext in (".csv", ".xlsx", ".xls"):
            from metronix.ingestion.processors.tabular import process_tabular_file
    ...
    def _handle_greeting(self, user_id: str, workspace_id: str) -> str:
        ...
        return (
            "Hello! I'm Metronix, your team's knowledge assistant.\n\n"
                ...
                messages=[
                    {
                        "role": "system",
                        "content": (
                            "You are Metronix, a helpful AI knowledge assistant for teams. "
    ...
    def _cmd_rebuild_aliases(self, workspace_id: str) -> str:
        ...
        from metronix.retrieval.aliases import seed_custom_aliases
        from metronix.storage.qdrant import get_hybrid_store
