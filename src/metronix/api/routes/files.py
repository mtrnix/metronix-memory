...
from metronix.auth.dependencies import require_admin, require_editor
from metronix.core.config import get_settings
from metronix.core.models import (  # noqa: TC001 — Annotated[User, Depends()] is runtime
    Document,
    User,
)
from metronix.ingestion.sync import persist_raw_documents, sync_documents_to_stores
