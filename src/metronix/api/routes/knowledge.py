...
from metronix.knowledge.service import (
...
def _memory_record_to_response(record: Any) -> KnowledgeRecordResponse:
    """Map a :class:`~metronix.core.models.MemoryRecord` to the unified shape."""
    updated_at: datetime = (
...
def _raw_document_to_response(doc: RawDocument) -> KnowledgeRecordResponse:
    """Map a :class:`~metronix.core.models.RawDocument` to the unified shape.
