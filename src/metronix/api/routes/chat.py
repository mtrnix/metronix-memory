...
Migrated from PoC metronix/api.py (the core Q&A endpoints).
"""
...
from metronix.api.dependencies import build_telemetry_context_cm, resolve_workspace_id
from metronix.auth.dependencies import require_editor
from metronix.core.models import User  # noqa: TC001 — Annotated[User, Depends()] is runtime
...
async def upload_file(
    ...
    """
    from metronix.api.routes.files import _ingest_uploads
