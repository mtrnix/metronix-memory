...
Allows Open WebUI (and any OpenAI-compatible client) to use Metronix
...
from metronix.retrieval.trace import append_trace_footer, maybe_create_trace
...
def _parse_workspace_id(model: str) -> str | None:
    """Extract workspace_id from model id like 'metronix-rag-MTRNIX'."""
...
async def openapi_stub() -> dict:
    ...
    return {
        "openapi": "3.1.0",
        "info": {"title": "Metronix OpenAI-compatible API", "version": "0.1.0"},
        "paths": {},
    }
...
async def _stream_response(
    ...
    from metronix.api.routes.chat import extract_sources_section, split_into_sentences
