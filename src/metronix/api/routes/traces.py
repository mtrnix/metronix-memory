...
``METRONIX_RAG_TRACE_ENABLED`` — historical traces stay readable even after
...
async def get_trace(
    ...
    from metronix.storage.pg_connection import get_rag_trace_sync
...
async def list_traces(
    ...
    workspace_id = resolve_workspace_id(request)
    from metronix.storage.pg_connection import count_rag_traces_sync, list_rag_traces_sync
