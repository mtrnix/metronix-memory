...
from metronix.benchmarker.services.metrics.context_precision import (
    ContextPrecisionMetric,
)
from metronix.benchmarker.services.metrics.context_recall import (
    ContextRecallMetric,
)
from metronix.benchmarker.services.metrics.faithfulness import (
    FaithfulnessMetric,
)
from metronix.benchmarker.services.metrics.qed import QEDMetricsCalculator
from metronix.benchmarker.services.metrics.relevancy import (
...
class MetricsController:
    ...
    def from_settings(cls, settings: Settings) -> MetricsController:
        """Create a MetricsController from Metronix Core settings.
