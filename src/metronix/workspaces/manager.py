...
Migrated from PoC metronix/workspaces/manager.py.
...
class WorkspaceManager:
        ...
        if use_persistence:
            try:
                ...
                if settings.workspace_persistence in ("memgraph", "neo4j"):
                    from metronix.workspaces.persistence import get_workspace_persistence
    ...
    def get_workspace(self, workspace_id: str) -> Workspace | None:
        from metronix.core.utils import normalize_workspace_id
