"""MCP tool: metronix_source_update — update a data-source connection."""
...
async def metronix_source_update(
    connection_id: str,
    ...
    try:
        from metronix.connectors.schemas import validate_config_for_update
        ...
        return {"error": handle_tool_error("metronix_source_update", e).to_dict()}
