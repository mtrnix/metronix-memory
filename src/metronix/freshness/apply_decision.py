...
Extracted from :mod:`metronix.freshness.decision_engine` (Phase A) so it can
...
from metronix.core.models import LifecycleStatus, ReviewEntry

if TYPE_CHECKING:
    from metronix.core.models import FreshnessDecision
    from metronix.freshness.targets import FreshnessTarget, FreshnessTargetRecord
