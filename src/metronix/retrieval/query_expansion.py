...
- "What is Metronix?" → Metronix MTRNIX platform knowledge base"""
...
def _build_expansion_prompt(query: str) -> str:
    ...
    from metronix.retrieval.search import detect_response_language
...
def expand_query(query: str, timeout: int | None = None) -> str:
    if timeout is None:
        ...
        timeout = int(_os.getenv("METRONIX_AUX_LLM_TIMEOUT", "10"))
