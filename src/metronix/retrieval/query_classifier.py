...
from metronix.ingestion.processors.dates import extract_date_range
...
Examples: "What is Metronix?", "How does RBAC work?"
...
def _llm_classify(query: str) -> QueryClassification:
    ...
    try:
        raw = chat_completion(
            ...
            temperature=0.0,
            max_tokens=60,
            timeout=int(os.getenv("METRONIX_AUX_LLM_TIMEOUT", "10")),
