...
class Settings(BaseSettings):
    ...
    retrieval_graph_ppr_enabled: bool = Field(
        False, alias="METRONIX_RETRIEVAL_GRAPH_PPR_ENABLED"
    )
    ...
    retrieval_graph_ppr_max_nodes: int = Field(
        500, alias="METRONIX_RETRIEVAL_GRAPH_PPR_MAX_NODES"
    )
