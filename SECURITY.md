...
Email: `security@mtrnix.com` (preferred) or use GitHub's [private vulnerability reporting](https://github.com/mtrnix/metatroncore/security/advisories/new).
...
- **Metatron Core** — the API server, MCP server, ingestion/retrieval pipelines, memory service, connectors
...
5. **Enable** `METATRON_AUTH_REQUIRED=true` in production — this gates all endpoints behind JWT.
