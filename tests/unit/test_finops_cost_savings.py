...
class TestCostCalculation:
    ...
    def test_single_provider_cost(self):
        ...
        from metronix.api.routes.finops import _calculate_doc_costs
    ...
    def test_metronix_cost(self):
        """Metronix cost is INFRA_COST_PER_QUERY * fetch_count."""
        from metronix.api.routes.finops import _metronix_cost

        assert abs(_metronix_cost(10) - 0.005) < 0.0001
...
class TestFetchCostSavingsAggregation:
    ...
    def test_aggregates_all_docs_for_summary(self, mock_get_session):
        ...
        from metronix.api.routes.finops import _fetch_cost_savings
    ...
    def test_empty_result_returns_zeroes(self, mock_get_session):
        ...
        assert result["summary"]["metronix_cost"] == 0.0
    ...
    def test_response_schema_structure(self, mock_get_session):
        ...
        assert "metronix_cost" in summary
