...
from metronix.retrieval.search import resolve_query


class TestResolveQuery:
    """Tests for resolve_query() — LLM query reference resolver."""

    @patch("metronix.retrieval.search.chat_completion")
    ...
    def test_passthrough_standalone_query(self, mock_llm) -> None:
        mock_llm.return_value = "What is Metronix?"
        result = resolve_query("What is Metronix?")
        assert result == "What is Metronix?"
