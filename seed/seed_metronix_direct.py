#!/usr/bin/env python3
"""Direct Metronix ingestion for synthetic demo data.
...
Usage:
    python seed/seed_metronix_direct.py --workspace demo
    python seed/seed_metronix_direct.py --workspace demo --only jira
    python seed/seed_metronix_direct.py --workspace demo --dry-run
    python seed/seed_metronix_direct.py --workspace demo --skip-graph
...
from metronix.core.models import Document  # noqa: E402
from metronix.ingestion.pipeline import ingest_documents  # noqa: E402
...
GITHUB_DEMO_BASE = os.environ.get(
    "GITHUB_DEMO_BASE",
    "https://github.com/mtrnix/metronixcore/blob/develop/demo-data",
)
